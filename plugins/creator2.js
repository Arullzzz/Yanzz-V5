...
let handler = async (m, { conn, args, usedPrefix, command }) => {
	let fkon = { key: { fromMe: false, participant: `0@s.whatsapp.net`, ...(m.chat ? { remoteJid: '16504228206@s.whatsapp.net' } : {}) }, message: { contactMessage: { displayName: `ᴏᴡɴᴇʀ ᴋᴀɴɴᴀʙᴏᴛ`, vcard: `BEGIN:VCARD\nVERSION:3.0\nN:;a,;;;\nFN:ᴏᴡɴᴇʀ ᴋᴀɴɴᴀʙᴏᴛ\nitem1.TEL;waid=62831433937633:62831433937633\nitem1.X-ABLabel:Ponsel\nEND:VCARD`}}}
...
menemukan bug?
 ...
 📮 *NOTE:*
 ${ow} Tidak menerima Save / kenalan
 ${ow} Hanya menjawab chat seputar BOT`
  ...
  }, MessageType.contactsArray, { quoted: fkon })
}
handler.help = ['owner', 'creator']
handler.tags = ['info']

handler.command = /^(nowner|owner|creator)$/i
